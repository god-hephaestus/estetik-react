  ...
  return (
    <Carousel arrows={true} infinite={true} draggable>
      {doctorDescription.map((doctor, index) => (
        <div
          key={index}
          className="flex flex-col md:flex-col lg:flex-row items-center h-[474px] md:h-[446px] lg:h-[300px] gap-4 lg:gap-0 mx-0 pr-4 lg:pr-10 bg-[#d0eeec] border-2 border-[#d0eeec] rounded-[25px]"
        >
