  ...
  return (
    <div className="flex justify-center lg:h-[470px] 2xl:h-[490px] items-center">
      <Form
        ...
        className="w-full h-full flex-1 px-6 bg-[#c0a062] rounded-[25px] border-2 border-[#c0a062] "
      >
        <Form.Item
          name="utm_source"
        ...
        >
          <Input
            className="border-2 border-[#151515] bg-[#c0a062] h-[40px] rounded-[25px]"
        ...
        >
          <div className="flex items-center space-x-2">
            <Select
              ...
              className="select-bg w-1/2 lg:3/5 border-2 border-[#151515] rounded-[25px] h-[40px]"
              popupClassName="bg-[#c0a062]"
            >
            ...
            <Input
              ...
              maxLength={10}
              className="w-1/2 lg:w-3/5 border-2 border-[#151515] bg-[#c0a062] h-[40px] rounded-[25px]"
            />
          </div>
        </Form.Item>
        <Form.Item
        ...
        >
          <TextArea
            ...
            className="border-2 border-[#151515] bg-[#c0a062] rounded-[25px]"
          />
        </Form.Item>
        <Form.Item className="text-right mt-4">
          <Button
            className="bg-[#151515] px-12 rounded-[25px] text-white h-[32px] lg:h-[40px]"
            htmlType="submit"
            disabled={submitted}
          >
