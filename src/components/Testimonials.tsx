...
export default function Testimonials({
  ...
  const containerClassNames = `no-scrollbar bg-[#13a89e]/20 lg:mt-0 border-2 border-[#13a89e] lg:border-none backdrop-blur lg:backdrop-blur-none lg:bg-[#d0eeec] shadow-md rounded-[25px] px-2 flex flex-grow overflow-x-auto cursor-${
    isDragging ? "grabbing" : "grab"
  } no-select ${
    isExpanded
      ? "h-[270px] lg:h-[280px] xl:h-[250px] backdrop-blur-none bg-[#d0eeec]"
      : "h-[270px] lg:h-[280px] xl:h-[250px] backdrop-blur bg-[#13a89e]/20 "
  }`;
