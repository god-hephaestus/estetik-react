...
export const metadata: Metadata = {
  title: "Estetik International | Meme Estetiği",
  description:
    "Estetik International'da meme estetiği ile istediğiniz görünüme kavuşun. Uzman ekibimizle doğal sonuçlar için hemen randevu alın!",
};
