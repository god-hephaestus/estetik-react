...
export const metadata: Metadata = {
  title: "Estetik International | Plastik Cerrahi",
  description:
    "Estetik International'da plastik cerrahi ile istediğiniz görünüme kavuşun. Uzman ekibimizle doğal sonuçlar için hemen randevu alın!",
};
