...
export const metadata: Metadata = {
  title: "Estetik International | Total Body Reshaping",
  description:
    "Total body reshaping ile vücut hatlarınızı yenileyin! Estetik International'da kişisel hedeflerinize özel çözümler sunuyoruz.",
};
