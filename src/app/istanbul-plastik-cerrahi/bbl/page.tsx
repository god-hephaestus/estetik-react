...
export const metadata: Metadata = {
  title: "Estetik International | BBL",
  description:
    "Brezilya popo kaldırma (BBL) ile dolgun hatlara sahip olun! Estetik International'da uzmanlarımızla doğal sonuçlar elde edin!",
};
