import ParentState from "@/components/istanbul-plastik-cerrahi/ParentState";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "Estetik International | Rinoplasti",
  description:
    "Rinoplasti ile burun şeklinizi yeniden tanımlayın! Estetik International'da uzman doktorlarımızla estetik ihtiyaçlarınıza uygun çözümler sunuyor.",
};
